-- Backend-only access to the ChargeNow Basic credentials stored in Supabase Vault.
-- Secret values are provisioned out-of-band in staging and are never committed.
