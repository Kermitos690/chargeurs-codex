-- Provider callbacks and HTTP 200 responses are evidence, not physical proof.
-- Canonical battery_released / rental_activated events are accepted only after
-- the read-only four-slot reconciler classified exactly one expected release.
