...
begin
  ...
  -- is currently rentable because batteries are recharging. It is not offline.
  ...
  -- ChargeNow business code 2005 is an explicit offline signal.
  ...
  -- Unknown supplier/transport failures are not proof of physical offline.
