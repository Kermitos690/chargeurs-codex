-- The deployed Premium guest profile uses the same CHF 30 guarantee as the
-- Checkout contract. Keep the beta gate exact and fail-closed; the retired
-- zero-deposit assertion would otherwise reject every valid Guest rental.
