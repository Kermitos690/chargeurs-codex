...
Deno.test("restart reuses active PaymentIntent and explicit retry advances idempotency generation", () => {
  assert(backendSource.includes("Restart/retry: an active existing PI remains authoritative and is reused."));
