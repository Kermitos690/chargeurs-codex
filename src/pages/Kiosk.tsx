        ...
        <AnimatePresence mode="wait">
          ...
          {phase === "pricing" && (
            <motion.div key="pricing" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="kiosk-pricing-stage flex w-full max-w-[82rem] flex-col items-center gap-7 px-4">
              ...
              ) : <p className="text-warning">{quoteError === "KIOSK_AUTH_REQUIRED" || quoteError === "KIOSK_AUTH_INVALID" ? t("kiosk.pricing.auth_error") : quoteError ? t("kiosk.pricing.error") : t("kiosk.pricing.loading")}</p>}
