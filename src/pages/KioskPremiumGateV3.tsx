 ...
 * - KioskAdvertisingLayer is an isolated fail-safe paid-media surface. It never owns
 *   rental, payment, return, inventory or hardware state and may disappear without
 *   affecting the product flow.
