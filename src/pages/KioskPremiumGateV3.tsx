...
import "./kiosk-premium-home-2026.css";
 ...
 * - kiosk-premium-home-2026.css styles that same Home DOM; it creates no second owner.
...
export default function KioskPremiumGateV3() {
  useLayoutEffect(() => {
    document.documentElement.dataset.kioskVersion = "premium-single-owner-home-2026-1280x720";
  ...
  return (
    <div className="kv3-runtime" data-presentation-owner="premium-single-owner-home-2026">
