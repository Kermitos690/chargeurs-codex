...
/**
 * P0 recovery entry: one visible transaction owner at a time.
 *
 ...
 *
 * Legacy presentation directors, cinematic/touch/recovery overlays, duplicate
 * journey chrome and WebView-failsafe styling remain deliberately excluded from
 * this entry during recovery. They were independent DOM observers/painters and
 * could race the canonical surface during cold boot or service-worker activation.
 */
