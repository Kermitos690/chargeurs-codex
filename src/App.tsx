...
import KioskPremiumGateV2 from "./pages/KioskPremiumGateV2.tsx";
      ...
      <TooltipProvider>
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route path="/kiosk/:stationId" element={<KioskPremiumGateV2 />} />
            <Route path="/kiosk/station/:stationId" element={<KioskPremiumGateV2 />} />
